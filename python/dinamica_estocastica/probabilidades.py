# La probabilidad de obtener un 12 al lanzar dos dados
...
def main(numero_de_tiros, numero_de_intentos):
	...
	print(f'Probabilidad de no obtener por lo menos un 12 en {numero_de_tiros} tiros = {probabilidad_tiros_con_12}')
